...
# Rows: 28,511
# Columns: 13
# $ id        <chr> "tt0000009", "tt0002101", "tt0002199", "tt…
# $ titulo    <chr> "Miss Jerry", "Cleopatra", "From the Mange…
# $ ano       <dbl> 1894, 1912, 1912, 1914, 1913, 1914, 1914, …
# $ diretor   <chr> "Alexander Black", "Charles L. Gaskill", "…
# $ duracao   <dbl> 45, 100, 60, 55, 88, 78, 70, 52, 63, 59, 5…
# $ generos   <chr> "Romance", "Drama| History", "Biography| D…
# $ pais      <chr> "USA", "USA", "USA", "USA", "USA", "USA", …
# $ orcamento <dbl> NA, 45000, NA, NA, 5700, NA, NA, NA, NA, 2…
# $ receita   <dbl> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA…
# $ nota_imdb <dbl> 5.9, 5.2, 5.7, 5.8, 6.0, 6.4, 6.5, 6.0, 5.…
# $ ator_1    <chr> "Blanche Bayliss", "Helen Gardner", "R. He…
# $ ator_2    <chr> " William Courtenay", " Pearl Sindelar", "…
# $ ator_3    <chr> " Chauncey Depew", " Miss Fielding", " Gen…
